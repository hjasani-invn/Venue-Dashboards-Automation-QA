...
class MagneticPositioningAccuracyUpdateTests(unittest.TestCase):
    ...
    #
    # @pytest.mark.run(1)
    # def test_3_6_login_valid(self):
    #     self.loginpage.login("AutomationTestUser001", "TP1M4St3R_p4ssw0rd")

    @pytest.mark.run(1)
    def test_3_6_1_source_delete_entry_1(self):
        # self.loginpage.login("AutomationTestUser001", "TP1M4St3R_p4ssw0rd")
        self.source_white_ignore_list_page.click_admin()
        # self.source_white_ignore_list_page.check_admin_dropdpwn()
    ...
    # @pytest.mark.run(3)
    # def test_3_6_3_white_ignore_list_entry(self):
    #     self.source_white_ignore_list_page.click_access_point_btn()
    #     self.source_white_ignore_list_page.click_wifi_btn()
    ...
    # @pytest.mark.run(4)
    # def test_3_6_4_manually_add_white_list_mac(self):
    #     self.source_white_ignore_list_page.click_access_point_btn()
    #     self.source_white_ignore_list_page.click_wifi_btn()
    #     self.source_white_ignore_list_page.enter_whitelist_mac(white_list = ["A1:B2:C3:D4:E5:F6", "A1:B2:C3:D4:E5:XX", "a1:b2:c3:d4:xx:xx", "A1:B2:C3:XX:xx:1E", "A1:B2:C3:XX:E5:XX", "C3:D4:E5:F6:A7:B8"])
    #     self.source_white_ignore_list_page.click_save_btn()
    #     time.sleep(900) # wait 15 mins to build fingerprint
    #     self.source_white_ignore_list_page.verify_fingerprint_timestamp()

    # @pytest.mark.run(5)
    # def test_3_6_5_upload_whitelist_csv(self):
    #     self.source_white_ignore_list_page.click_access_point_btn()
    #     self.source_white_ignore_list_page.click_wifi_btn()
    #     self.source_white_ignore_list_page.delete_white_mac_addresses()
    #     self.source_white_ignore_list_page.upload_white_list_csv()
    #     self.source_white_ignore_list_page.click_save_btn()
    #     time.sleep(750)  # wait 15 mins to build fingerprint
    #     self.source_white_ignore_list_page.verify_fingerprint_timestamp()
    ...
    # @pytest.mark.run(7)
    # def test_3_6_7_upload_ignorelist_csv(self):
    #     self.source_white_ignore_list_page.click_access_point_btn()
    #     self.source_white_ignore_list_page.click_wifi_btn()
    #     self.source_white_ignore_list_page.delete_ignore_mac_addresses()
    ...
    # @pytest.mark.run(8)
    # def test_3_6_8_upload_ignorelist_csv(self):
    #     self.source_white_ignore_list_page.click_access_point_btn()
    #     self.source_white_ignore_list_page.click_wifi_btn()
    #     self.source_white_ignore_list_page.delete_white_mac_addresses()
    #     self.source_white_ignore_list_page.delete_ignore_mac_addresses()
