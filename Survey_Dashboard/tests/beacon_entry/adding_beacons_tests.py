...
class AddBeaconTests(unittest.TestCase):
    ...
    @pytest.mark.run(29)
    def test_3_7_1_1_beacon_control_status_check(self):
        print("I'm beacon Adding test")
        self.addbeaconpage.select_none()
        self.addbeaconpage.select_beacons_box()
        self.seleniumdriver.screen_shot(file="test_3_7_1_1_beacon_control_status_check")
    ...
    @pytest.mark.run(30)
    def test_3_7_1_2_click_beacon_icon(self):
        print("I'm beacon Adding test")
        self.addbeaconpage.select_none()
        self.addbeaconpage.select_beacons_box()
        beacon_status = self.addbeaconpage.beacon_status()
    ...
    @pytest.mark.run(31)
    def test_3_7_1_3_add_beacon_data(self):
        print("I'm beacon Adding test")
        self.addbeaconpage.select_none()
        self.addbeaconpage.select_beacons_box()
        beacon_status = self.addbeaconpage.beacon_status()
        ...
        self.seleniumdriver.screen_shot(file="test_3_7_1_3_add_beacon_1_data")
        self.addbeaconpage.click_save_button()
        self.addbeaconpage.place_beacon(xoffset=120, yoffset=120)
        self.seleniumdriver.screen_shot(file="test_3_7_1_3_add_beacon_1_place")
        time.sleep(5)
        ...
        self.addbeaconpage.add_beacon_brand()  # value provides in page method
        self.seleniumdriver.screen_shot(file="test_3_7_1_3_add_beacon_2_data")
        self.addbeaconpage.click_save_button()
        self.addbeaconpage.place_beacon(xoffset=150, yoffset=150)
        self.seleniumdriver.screen_shot(file="test_3_7_1_3_add_beacon_2_place")
        time.sleep(5)
        ...
        self.addbeaconpage.add_beacon_type_1()  # value provides in page method
        self.addbeaconpage.add_beacon_brand()  # value provides in page method
        self.seleniumdriver.screen_shot(file="test_3_7_1_3_add_beacon_3_data")
        self.addbeaconpage.click_save_button()
        self.addbeaconpage.place_beacon(xoffset=190, yoffset=190)
        self.seleniumdriver.screen_shot(file="test_3_7_1_3_add_beacon_3_place")

        self.addbeaconpage.save_all()
        self.seleniumdriver.screen_shot(file="test_3_7_1_3_add_beacon_all_beacon_save")
